...
def LLM_request(toy_item_attribute, adjacency_list_dict, candidate_indices_dict, index, model_type,
    ...
    if index in augmented_sample_dict:
        ...
        # except ValueError as e:
            ...
            time.sleep(10)
            LLM_request(toy_item_attribute, adjacency_list_dict, candidate_indices_dict, index, "gpt-3.5-turbo-0613",
                        augmented_sample_dict)
...
for index in range(0, len(adjacency_list_dict)):
    # # make prompting
    re = LLM_request(toy_item_attribute, adjacency_list_dict, candidate_indices_dict, index, "gpt-3.5-turbo",
                     augmented_sample_dict)
