    ...
    for value in augmented_atttribute_embedding_dict.keys():
        ...
        if indices[0] in augmented_atttribute_embedding_dict[value]:
            ...
            try:
                ...
                # pickle.dump(augmented_sample_dict, open('augmented_sample_dict','wb'))
                pickle.dump(augmented_atttribute_embedding_dict,
            ...
            # except ValueError as e:
                ...
                time.sleep(5)
                # print(content)
                LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002",
                            augmented_atttribute_embedding_dict, error_cnt)
            except ValueError as ve:
...
def LLM_request(toy_augmented_item_attribute, indices, model_type, augmented_atttribute_embedding_dict, error_cnt, key,
                file_name):
    for value in augmented_atttribute_embedding_dict.keys():
        if indices[0] in augmented_atttribute_embedding_dict[value]:
            # return 0
            ...
            # except ValueError as e:
                ...
                # print(content)
                LLM_request(toy_augmented_item_attribute, indices, "text-embedding-ada-002",
                            augmented_atttribute_embedding_dict, error_cnt, key, file_name)
            except ValueError as ve:
                print("An error occurred while parsing the response:", str(ve))
                time.sleep(5)
                # print(content)
