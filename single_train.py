...
from data.dataset import UniRPQRecDataset
import os
import faiss
import torch
...
def ftrain(model_name, dataset, pretrained_file='', finetune_mode='', **kwargs):
    ...
    # model_A = nn.DataParallel(model_A)  # 添加这一行
    # model_A.module.rpq_codes.to(config['device'])  # 修改这一行
...
if __name__ == '__main__':
    ...
    print(args)
    ftrain(args.m, args.d, pretrained_file=args.p, finetune_mode=args.f)