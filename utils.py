...
def parse_faiss_index(pq_index):
    ...
    rpq_codes = faiss.rev_swig_ptr(invlists.get_codes(0), ls * invlists.code_size)
    rpq_codes = rpq_codes.reshape(-1, invlists.code_size)
    ...
    return rpq_codes, centroid_embeds, coarse_embeds, opq_transform
